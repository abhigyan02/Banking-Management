...
#aadhar number
    aadhar=dataentering.aadhar(first_name, cur)

    print("=========== Final Data ===========")
    print(acc_no,acc_type,first_name,last_name,gender,birth_date,acc_creation_date,mobile_no,email_id,password,aadhar)
    add_client=("INSERT INTO clients "
    "(acc_no,type,first_name,last_name,gender,birth_date,accd,mobile_no,email_id,pass,aadhar) "
    "VALUES (%s,%s,%s,%s,%s,%s,%s,LPAD(%s,%s,'0'),%s,%s, %s)")
    data_client=(acc_no,acc_type,first_name,last_name,gender,birth_date,acc_creation_date,mobile_no,lmn,email_id,password,aadhar)
